...
* [Spring Data JPA](https://docs.spring.io/spring-boot/docs/2.7.13.RELEASE/reference/htmlsingle/#data.sql.jpa-and-spring-data)
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/2.7.13.RELEASE/reference/htmlsingle/#howto.data-access.exposing-spring-data-repositories-as-rest)
